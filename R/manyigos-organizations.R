...
#' following 5 datasets: COW, VIGO, DIGO, IIGO, TRANSACCESS.
...
#' uzbekistan, vanuatu, venezuela, vietnam, wgermany, wsamoa, wurtenburg, yemen,
#' yugoslaviaserb, zaire, zambia, zanzibar, zimbabwe, orgname, dead, integrated,
#' replaced, ionum, igocode, version, accuracyofpre1965membershipdates,
...
#' Nbr State Mbrs 2017 (or end), Ind. Sec. Year, Formal Treaty Year, Follow-on IO.}
