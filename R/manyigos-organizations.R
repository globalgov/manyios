...
#' following 6 datasets: COW, VIGO, DIGO, IIGO, TRANSACCESS, YIO.
...
#' 12 variables: igoID, Label, Beg, End, End_reason, Regional, Nbr., Domain, Nbr State Mbrs 2017 (or end), Ind. Sec. Year, Formal Treaty Year, Follow-on IO.}
#' \item{TRANSACCESS: }{A dataset with 9007 observations and the following
#' 32 variables: igoID, Label, igobodyID, IGOBody, Beg, Year, access, ID, ID_IO, ID_Body, openbody, multiple_arr, range_1, depth_1, permanence_1, codification_1, range_2, depth_2, permanence_2, codification_2, range_3, depth_3, permanence_3, codification_3, range_4, depth_4, permanence_4, codification_4, range_5, depth_5, permanence_5, codification_5.}
