...
#' @param text A vector of text to search for organization names within.
#' @param code Logical whether the function should return the 
#'   four- to five-letter abbreviation or the name of the organization.
#'   For the complete list of entities and their search terms, 
#'   run the function without an argument (i.e. `code_orgs()`).
#'   Updates and suggestions welcome.
#' @param max_count Integer how many organizations to search for in each element
#'   of the vector.
...
"CILSS","Perm. Interstate Comm. for Drought Control in the Sahel",
"CEDCA","Org. of Coord. for Control of Endemic Diseases in Cent. Afr.",
"CSPLT","Intl Comm of Cape Spartel Light",
"CNWAF","Intl Comm for NW Atlantic Fisheries",
"CERN","European Org for Nuclear Research",
"CEPGL","Economic Community of Great Lakes States",
"CSSRB","Administrative Center for Soc Security for Rhine Boatmen",           
"CAMES","Afr. & Malagasy Council for Higher Ed.",
"CWGC","Commonwealth War Graves Commission",
"CABI","CAB International",
"CSLF","Carbon Sequestration Leadership Forum",
"CRCOM","Caribbean Community",
"CRCMS","Caribbean Commission",
"CRDB","Caribbean Development Bank",
"CRXC","Caribb. Examinations Council",
"CFATF","Caribbean Fin. Action Task Force",
"CARFT","Caribbean Free Trade Area",
"CARO","Caribbean Organization",
"CARPU","Caribbean Postal Union",
"CACB","Central Am. Coffee Board",
"CAEC","Cent. American Energy Comm.",
"CAIPA","Centr. Am. Instit. for Public Admin.",
"CAMSF","Cent. Am Monetary Stab. Fund",
"CARII","Central American Research Institute for Industry",
"CEEPN","Central & Eastern Eur. Privatization Network",
"CAECC","Central Asian Cooperation Organization",
"CBIMW","Centrl Bureau: Intl Map of World",
"CCNR","Central Commission for the Navigation of the Rhine",
"CCOM","Cent. Compensation Off. of Maghreb",
"CEFTA","Central Europe FTA",
"CEUIN","Central European Initiative",
"CPAB","Central PanAm Bureau Eugenics",
"CENTO","Central Treaty Organization",
"CFRN","Coalition for Rainforest Nations",
"CCPA","Cocoa Producers Alliance",
"CSTO","Collective Security Treaty Organization",
"CSAVE","COSAVE",
"CIFC","Comm Intl Finan Cntrl Macedonia",
"CTCAF","Comm Tech Cooperation in SSAf",
"CFCOM","Common Fund for Commodities",
"CMESA","Comm Market for East/South Africa",
"CAARC","Commonwealth Advis. Aero. Research Council",
"COMAB","Commonwealth Agricultural Bureau",
"CATC","Commonwealth Air Transport Council",
"COMEC","Commonwealth Economic Committee",
"CELC","Commonwealth Education Liaison Committee",
"COMIS","Commonwealth of Independent States",
"COMSC","Commonwealth Secretariat",
"COMTO","Commonwealth Telecom Board",
"CEMAC","Central African Economic & Monetary Union",
"CPSC","Comm Portugese Speaking Countries",
"CAAD","Concerted Action for African Develop.",
"CIMA","Inter-African Conference on Insurance Markets",
"CMJF","Conference des Ministres jeunesse Francais",
"CAMSD","Conf. African Ministers for Sustain Development",
"CHSEA","Conference Heads of State of Equ. Africa",
"CMAOC","Conference of Ministers of Agriculture of West and Central Africa",
"CPTAC","Conf. of Posts & Telecommunications  of Central Africa",
"CICA","Conference on Interaction and Confidence-Building Measures in Asia",
"CACI","Conferencia de Autoridades Cinematogrficas de Iberoamerica",
"CBFP","Congo Basin Forest Partnership",
"CANDB","Convenio Andres Bello",
"CMEA","Council for Mutual Economic Aid",
"CLMBO","Council for Tech Coop in S & SE Asia",
"COEU","Council of Europe",
"CMAEC","Council of Min. Asian Econ. Coop.",
"CMHAG","Council of Min. of Health of Arab Gulf States",
...
## I ####
"INSMK","InfoSAMAK",
"IABE","Ibero-Am Office of Education",
"IMPDC","Imperial Defense Cmte",
"IIENT","Imperial Institute of Entomology",
"IMYI","Imperial Mycological Institute",
"IOCMN","Indian Ocean Comm",
"IORRC","Indian Ocean Rim Association for Regional Cooperation",
"INCAP","Instit Nutrition for Cent Am & Pan",
"IACS","Inter-Af Cmte Stat",
"IAPHY","Inter-Af Phyto Convention",
"IARA","Inter Allied Reparation Agency",
"IARHC","Inter Allied Rhineland High Comm",
"IACI","Inter-Am Children's Instit",
"IACB","Inter-Am Coffee Board",
"IACW","Inter Am Comm Women",
"IACSS","Inter-Am Conf on Social Security",
"IADFB","Inter-American Defense Board",
"IADB","Inter-Am Dev Bank",
"IAFC","Inter-Am Fed of Cotton",
"IAHC","Inter American High Comm",
"IAII","Inter-American Indian Insitit",
"IAIAS","Inter-Am Instit of Ag Science",
"IAIC","Inter-Am Invest Corp.",
"IARAD","Inter-American Radio Office",
"IATB","Inter Am Trdmk Bureau",
"IATTC","Inter-Am Tropical Tuna Comm",
"IAIGC","Inter-Arab Investment Guarantee Corp.",
"IGAD","Inter-Gov Authority on Drought Protection",
"IGBI","Intergov. Bureau for Infomatics",
"IOMIG","Intl Org for Migration",
"IGCC","Intergov Copyright Comte",
"ICCEC","Intgvt Council of Copper Exp. Countries",
"IOGC","Intergov. Oceanographic Comm.",
"IFISH","InfoFish",
"ITVRC","Intgvt TV & Radio Corp",
"IUIC","Intergovernmental University of Cooperation",
"ICILM","Interim Comm. for Coor. Investigations of the Lower Mek",
"IALDT","Intl Advisory Cmte Long Distance Tele",
"IAMLO","Intl Af Migratory Locust Org",
"IATSJ","Intl Arbitration Trib at San Jose",
"IAPB","Intl Assoc for Public Baths",
"ISEIS","Intl Assoc Seismology",
"IASAJ","Int'l Assoc. of Supreme Admin. Jurisdictions",
"IAEA","Intl Atomic Energy Agency",
"IARHR","Intl Authority Ruhr",
"IBEC","Intl Bank Economic Coop",
"IBRD","World Bank",
"IBXA","Int'l Bauxite Assoc.",
"IBIER","Intl Bureau Inform Enquiry Relief",
"IBPMP","Int Comm for Protection of Moselle",
"ICPRP","Int Comm Protect Rhine Pollution",
"IBCS","Intl Bureau Commercial Stat",
"IBED","Intl Bureau Education",
"BIPM","International Bureau of Weights & Measures",
"ICAMO","Intl Central American Office",
"ICFAM","Intergovernmental Institution for the use of Micro-Algae Spirulina",
"ICHEM","Intl Chemistry Office",
"ICAO","Intl Civil Aviation Org",
"ICVDF","Int'l Civil Defence Org.",
"ICOC","Int'l Cocoa Org.",
"ICOF","Intl Coffee Org",
"ICDR","Intl Comm for Decenn. Revision Nomen",
"ICHRB","Int'l Comm. for the Hydrology of the Rhine Basin",
"ICNC","Intl Comm Navigation of Congo",
"ICOMO","Intl Comm for the Oder",
"ICSE","Intl Comm Scientific Exploration of Med Sea",
"ICAI","International Commission for Agricultural Industries",
"ICCS","Intl Comm on Civil Status",
"ICTM","Intl Comm Teaching Math",
"ICMMP","Intl Comte of Military Medicine & Pharmacy",
"ICPTU","Intl Conf Promoting Tech Unification",
"ICSG","Int'l Copper Study Grp.",
"ICRI","Int'l Coral Reef Initiative",
"ICAC","Intl Cotton Adv Comte",
"ICES","Intl Council for Exploration of Sea",
"IPOL","Intl Criminal Police Comm",
"ICCT","International Criminal Court",
"IELBC","Intl Elbe Comm",
"IENA","Intl Energy Agency",
"IEXS","Intl Exchange Service",
"IEXB","Intl Exhib Bureau",
"IFCA","Intl Finance Comm at Athens",
"IFINC","Intl Finance Corporation",
"IFAD","Int Fund for Agriculture & Development",
"FARAL","Intl Fund for Saving Aral Sea",
"IHYO","Intl Hydrographic Org",
"IIWEE","International Institute for Water and Environment Engineering",
"IIAG","Intl Institute of Ag",
"IICOM","Intl Instit of Commerce",
"IIREF","Intl Instit of Refrigeration",
"IJUTO","Int'l Jute Organization",
"ILABO","Intl Labour Org",
"ILZSG","Intl Lead & Zinc Study Group",
"IMBSV","Intl Maritime Bureau Against Slave",
"IMARO","Intl Maritime Org",
"IMSO","Int'l Mobile Satellite Org.",
"IMONF","Intl Monetary Fund",
"IMOSC","Intl Moselle Comp",
"INRO","Int'l Natural Rubber Org.",
"INSG","Int'l Nickel Study Group",
"INPFC","International North Pacific Fisheries Commission",
"IOEZ","Intl Office Epizootics",
"IOPH","Intl Office Public Hygiene",
"IOPCF","Int'l Oil Pollution Compens. Funds",
"IOOC","Intl Olive Oil Council",
"IOLM","Intl Org Legal Metrology",
"IPATI","Intl Patent Institute",
"IPEDI","Int'l Pedological Instit",
"IPENC","Intl Penitentiary Comm",
"IPEPC","Int'l Pepper Community",
"IPHYL","Intl Physiological Lab",
"IPRZC","Intl Prize Court",
"IRLCS","Intl Red Locust Control Service",
"IRFGO","Intl Refugee Org",
"IRLFU","Intl Relief Union",
"IRENA","International Renewable Energy Agency",
"IRSG","Intl Rubber Study Group",
"ISRBC","International Sava River Basin Commission",
"ISBDA","Int'l Seabed Authority",
"ISUPT","Intl Sec for Unification Pharmaco",
"ISUGC","Intl Sugar Council",
"ITPA","Int'l Tea Promotion Assoc.",
"ITCLE","Intl Tech Cmte Legal Experts Air Questions",
"ITELU","Intl Telecom Union",
"ITSAT","Int'l Telecomm. Satellite Org.",
"ITCC","Intl Telegraph Consultative Cmte",
"IIFEO","ITER International Fusion Energy Organization",
"ITINC","Intl Tin Council",
"ITRO","International Tripartite Rubber Organization, Thailand",
"ITTO","Int'l Tropical Timber Org",
"IUPIP","Intl Union for Protection of Industrial Prop (Paris Convention)",
"IUPCT","Intl Union Publication of Customs Tariffs",
"IUPR","Intl Union of Pruth",
"IVWO","Intl Vine & Wine Office",
"IWHLC","Intl Whaling Comm",
"IGRNC","Intl Grains Council",
"IWSG","Intl Wool Study Group",
"IOCMT","Interoceanmetall",
"ISBK","Interstate Bank",
"IOATH","Inter-St Org. for Advanced Technicians of Hydraulics...",
"ISHRE","Inter-State School for Hydraulic & Rural Engin...",
...
"UPNVP","Union for Protection of New Varieties of Plants",
