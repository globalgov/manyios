...
If you have already developed a dataset salient to this package, please reach out by flagging it as an [issue](https://github.com/globalgov/manyigos/issues) for us, or by forking, further developing the package yourself, and opening a [pull request](https://github.com/globalgov/manyigos/pulls) so that your data can easily be integrated into the package.
