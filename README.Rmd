...
`manyios` is a data package within the
...
Once you have installed `{manydata}`, you can see the different datasets included in a specific datacube in the `{manyios}` package using the following function.
